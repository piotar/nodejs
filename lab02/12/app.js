...
// wczytujemy podrany moduł `yargs` 
const yargs = require('yargs');

// pobieramy parametr city z naszych parametrów wejściowych aplikacji
// node app --city=bialystok
const city = yargs.argv.city;

// deklarujemy zmienną z naszym adresem do API z dynamiczną zmienną `city`
const url = `https://api.openweathermap.org/data/2.5/weather?APPID=0ed761300a2725ca778c07831ae64d6e&q=${city}`;
